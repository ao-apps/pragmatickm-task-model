 ...
 */
package com.pragmatickm.task.model.book;
...
@WebServlet("/task/model/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		HttpServletUtil.sendRedirect(
			...
			"/task/model/apidocs/com.pragmatickm.task.model/com" + Objects.toString(req.getPathInfo(), ""),

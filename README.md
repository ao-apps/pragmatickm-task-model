...
[![Build](https://github.com/ao-apps/pragmatickm-task-model/actions/workflows/build.yml/badge.svg?branch=1.x)](https://github.com/ao-apps/pragmatickm-task-model/actions?query=workflow%3ABuild)
